...
const { Article, Category, User, Factura, Billitems, Cartitems, Wishlist, Review, Address } = sequelize.models;
...
//User > aaddress
User.belongsToMany(Address, { through: Address });
Address.belongsTo(User, { through: Address })
